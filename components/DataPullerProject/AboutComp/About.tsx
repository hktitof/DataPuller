    ...
    <div className="w-full h-full py-8 md:px-8 flex md:flex-row flex-col md:space-x-12 items-center space-y-4">
      ...
      <div className="flex flex-col space-y-8  items-center">
        ...
        <span className="font-sans italic  sm:text-base text-sm text-gray-400 text-center">
          ...
          you start sharing your IP address as soon as you go online, which can be used to pinpoint your approximate
          location. note that the information you see above is used to generate your fingerprint, This information is used by websites to build
